...
#define LV_FONT_CUSTOM_DECLARE LV_FONT_DECLARE(noto_thai_14) LV_FONT_DECLARE(noto_thai_12)

/*Always set a default font. noto_thai_14 covers the Thai block and falls back
 *to lv_font_montserrat_14 for Latin + LV_SYMBOL_* glyphs (see src/ui/noto_thai_14.c).*/
#define LV_FONT_DEFAULT &noto_thai_14
